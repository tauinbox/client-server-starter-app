...
|------|------|-------|--------|
| Server unit tests | Jest | `*.spec.ts` alongside source | 1536 tests passing |
| Server E2E tests | Jest | Separate config in `test/` | 241 tests passing (26 skip without Postgres/Redis/Mailpit) |
