...
| Server E2E tests | Jest | Separate config in `test/` | 253 tests; a run with Postgres + Mailpit reports 246 passing and 7 skipped, matching CI (suites gated on `DB_HOST` / `REDIS_URL` skip entirely on a bare run) |
