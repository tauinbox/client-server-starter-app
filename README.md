...
| Client unit tests | Vitest | `*.spec.ts` alongside source | 372 tests passing |
| Client E2E tests | Playwright | `e2e/` directory, uses mock-server (4 parallel workers) | 99 tests passing |
