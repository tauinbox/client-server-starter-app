...
|------|------|-------|--------|
| Server unit tests | Jest | `*.spec.ts` alongside source | 1366 tests passing |
| Server E2E tests | Jest | Separate config in `test/` | 198 tests passing |
| Client unit tests | Vitest | `*.spec.ts` alongside source | 915 tests passing |
