...
│       ├── store/          # BillingStore — route-level signalStore (plans, products, subscription, paymentMethod, usage, credits, region + the invoice collection via withCursorList); loadPricing/loadSettings/checkout/purchase/refreshInvoices/loadMoreInvoices/changePlan/startPaymentMethodUpdate/cancel/setRegion
