...
│   ├── dtos/               # response DTOs (subscription/invoice/payment-method/checkout-session/region/usage/usage-summary) with WireType/StructuralDiff contract checks + checkout/cancel/region/refund/record-usage request DTOs
